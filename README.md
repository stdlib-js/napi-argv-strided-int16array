...
-   **err**: `[out] napi_value*` pointer for storing a JavaScript error. If not provided an `Int16Array` or sufficient elements, the function sets `err` with a JavaScript error; otherwise, `err` is set to `NULL`.
